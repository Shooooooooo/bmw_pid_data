...
static const b48_pid_data_entry b48_pid_data_data[] = {
    ...
    {0x4408, "Oil temperature unfiltered", "Â°C", "signed int", 1, 10, 0},
    ...
    {0x4506, "Angle of the inlet NW flanks relative to the crankshaft", "Â° KW", "unsigned int", 1, 10, 0},
    {0x4507, "Angle of the outlet NW flanks relative to the crankshaft", "Â° KW", "unsigned int", 1, 10, 0},
    ...
    {0x4A30, "Uneven running of cylinder 1", "1/sÂ²", "signed int", 0.00710545, 1, 0},
    {0x4A31, "Uneven running cylinder 2", "1/sÂ²", "signed int", 0.00710545, 1, 0},
    {0x4A32, "Uneven running cylinder 3", "1/sÂ²", "signed int", 0.00710545, 1, 0},
    {0x4A33, "Uneven running cylinder 4", "1/sÂ²", "signed int", 0.00710545, 1, 0},
    ...
    {0x4A94, "Saved camshaft target angle exhaust", "Â° KW", "signed int", 1, 128, 0},
    ...
    {0x5763, "Actual physical value", "Â°C", "signed int", 1, 10, -273.14},
    ...
    {0x579B, "Temperature in the particulate filter bank 1", "Â°C", "signed int", 1, 10, -273.14},
    ...
    {0x57C3, "Inlet spread", "Â° KW", "unsigned int", 1, 10, 0},
    ...
    {0x581A, "Angle inlet valve opens based on LWOT", "Â° KW", "signed int", 1, 128, 0},
    {0x581B, "Target angle camshaft inlet opens", "Â° KW", "signed int", 1, 128, 0},
    {0x581C, "Angle exhaust valve closes based on LWOT", "Â° KW", "signed int", 1, 128, 0},
    {0x581D, "Target angle camshaft exhaust closes", "Â° KW", "signed int", 1, 128, 0},
    ...
    {0x582F, "Exhaust gas temperature after catalytic converter from model", "Â°C", "unsigned char", 5, 1, -50},
    ...
    {0x5896, "Exhaust gas temperature behind main catalyst from model", "Â°C", "unsigned int", 0.0234375, 1, -273.15},
    ...
    {0x589E, "Setpoint eccentric angle VVT", "Â°", "unsigned int", 1, 10, 0},
    ...
    {0x592D, "KW angular offset when starting the engine", "Â° KW", "signed int", 1, 45.51111111, 0},
    {0x592E, "Engine stop position", "Â° KW", "signed int", 1, 45.51111111, 0},
    ...
    {0x594C, "Fuel temperature (sensor, model or fixed substitute value)", "Â°C", "unsigned char", 0.75, 1, -48},
    ...
    {0x5952, "Actual temperature", "Â°C", "unsigned char", 256, 256, -55},
    {0x5956, "Differential pressure ejector pump - environment", "hPa", "signed int", 10, 256, 0},
    {0x5957, "Engine room temperature", "Â°C", "signed int", 0.1, 1, -273.14},
    {0x5958, "Cylinder head temperature raw value", "Â°C", "signed int", 1, 10, -273.14},
    ...
    {0x59BD, "Inlet NW: Angular offset fine adaptation", "Â° KW", "signed long", 1, 45.511111, 0},
    {0x59BE, "Outlet NW: angular offset fine adaptation", "Â° KW", "signed long", 1, 45.511111, 0},
    ...
    {0x59FA, "Actual ignition angle", "Â° KW", "signed char", 191.25, 255, 0},
    {0x59FC, "Ignition angle output", "Â° KW", "signed char", 191.25, 255, 0},
    {0x59FD, "Target ignition angle from torque intervention", "Â° KW", "signed char", 191.25, 255, 0},
};
